                        ...
                        "content": [
                            {"type": "input_file", "file_id": uploaded.id},
                            {
                                ...
                                "text": (
                                    ...
                                    "Set payee to the exact transaction text shown on the bank "
                                    "statement, without normalizing it. Set note to a concise semantic "
                                    "description of what the transaction represents, such as "
                                    "'iPad purchase'. "
